...
//==========================zetsuboclient=======================//
global.botname = '⫹⸙⧉𝘿𝙀𝘼𝘿𝙋𝙊𝙊𝙇-𝙈𝘿⧉⸙⫺' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.packname = '⫹⸙⧉𝘿𝙀𝘼𝘿𝙋𝙊𝙊𝙇-𝙈𝘿⧉⸙⫺' // ubah aja ini nama sticker
global.author = '༻࿇𝘾𝙤𝙣𝙛𝙧𝙤𝙣𝙩𝙚𝙧❖༺' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
